...
?>
    <main>
        ...
        <form id="clear" class="add_form" method="post" action="#">
        ...
        <?php //if(isset($studentID)){echo $studentID;} else echo generateNewStudentID();?>" readonly="readonly">
                ...
                <input type="text" id="middleName" name="middleName" placeholder="" value="<?php //if(isset($middleName)){echo $middleName; }?>">
          ...
          <option <?php //if(isset($gender)&& $gender==2){echo "selected"; }?> value="2">Female</option>
                ...
                <input type="text" id="dateOfBirth" name="dateOfBirth" placeholder="" value="<?php //if(isset($dateOfBirth)){echo $dateOfBirth; }?>">
                ...
                <input type="text" id="NationalID" name="NationalID" placeholder="" value="<?php //if(isset($NationalID)){echo $NationalID; }?>">
          ...
          <option <?php //if(isset($guardianTitle)&& $guardianTitle==3){echo "selected"; }?> value="3">Ms</option>
                ...
                <input type="text" id="guardianRelationshipToStudent" name="guardianRelationshipToStudent" placeholder="" value="<?php //if(isset($guardianRelationshipToStudent)){echo $guardianRelationshipToStudent; }?>">
         ...
         <?php //if(isset($guardianHomeAddress)){echo($guardianHomeAddress); }?>
            ...
            <div class="details">
                ...
                <input type="text" id="guardianEmail" name="guardianEmail" placeholder="" value="<?php //if(isset($guardianEmail)){echo $guardianEmail; }?>">
